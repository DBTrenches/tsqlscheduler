...
- Deployment scripts use integrated security. Use of SQL Logins has not been tested but can be attempted but adding the appropriate [`Invoke-SqlCmd`][Invoke-SqlCmd -TrustServerCertificate - bol] flags in the [tsqlScheduler module](src/tsqlScheduler/tsqlScheduler.psm1).
...
[Invoke-SqlCmd -TrustServerCertificate - bol]: https://docs.microsoft.com/en-us/sql/powershell/invoke-sqlcmd-cmdlet
